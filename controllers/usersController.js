...
module.exports = {
    ...
    async login(req, res, next){
        try {
            ...
            return res.status(501).json({
                success: false,
                message: 'Error al intentar realizar el login de usuario',
                error: error
            });
        }
    },
    ...
    async update(req, res, next){
        try {
            ...
            const user = JSON.parse(req.body.user); // objeto user enviado con los datos del usuario
            ...
            await User.update(user); // almacenando la url en la base de datos
    ...
    async updateWithoutImage(req, res, next){
        try {
            ...
            const user = req.body; // objeto user enviado con los datos del usuario
            console.log('Usuario parseado', user);
